...
var UICarouselComponent = (function () {
    function UICarouselComponent(el) {
        this.el = el;
        this.nextSubject = new rxjs_1.Subject();
        this.prevSubject = new rxjs_1.Subject();
    ...
    UICarouselComponent.prototype.ngOnInit = function () {
        ...
        this.nextSubject.pipe(operators_1.throttleTime(this.speed)).subscribe(function () {
            if (!_this.fade) {
                _this.slideLeft();
            }
            else {
        ...
        this.prevSubject.pipe(operators_1.throttleTime(this.speed)).subscribe(function () {
            if (!_this.fade) {
                _this.slideRight();
            }
            else {
